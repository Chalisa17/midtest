...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        sql = "INSERT INTO people (id, name, phone, datepic ) VALUES " +
            "('1','สมชาย พายเรือ','088444XXXX','01/03/2019'), " +
            "('2','สมหญิง ยิงเรือ','088555XXXX','05/03/2019'), " +
            "('3','สมศรี ขี่เรือ','088666XXXX','07/03/2019'), " +
        "('4','Steve Jobs','088777XXXX','08/03/2019')"
    ...
    func select () {
        ...
        while(sqlite3_step(pointer) == SQLITE_ROW){
            ...
            textView.text?.append("ชื่อ: \(name)\n")
            
            phone = String(cString: sqlite3_column_text(pointer,2))
            textView.text?.append("เบอร์โทรศัพท์: \(phone)\n")
            
            datepic = String(cString: sqlite3_column_text(pointer,3))
